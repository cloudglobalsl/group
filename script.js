...
var T = {
  es: {
    ...
    serv3T: 'Seguridad Digital', serv3Desc: 'Protecci&oacute;n frente a amenazas con ciberseguridad integrada.',
    serv4T: 'Cloud Computing', serv4Desc: 'Infraestructura flexible y escalable para optimizar operaciones.',
    serv5T: 'Telecomunicaciones', serv5Desc: 'Comunicaci&oacute;n moderna integrando voz, datos y m&oacute;viles.',
    serv6T: 'Soporte T&eacute;cnico 24/7', serv6Desc: 'Asistencia experta para garantizar la continuidad de tus servicios.',

    /* SUSCRIPCIONES PAGE */
    subsEyebrow: 'Suscripciones', subsTitle: 'Suscripciones', subsDesc: 'Descubre nuestras soluciones y suscripciones',
    subsCard1T: 'Planes de Alojamiento', subsCard1Desc: 'Alojamiento web profesional para tu sitio', subsCard1Btn: 'Ver Planes de Alojamiento',
    subsCard2T: 'Planes de Alquiler', subsCard2Desc: 'Soluciones flexibles de alquiler tecnológico', subsCard2Btn: 'Ver Planes de Alquiler',
    subsCard3T: 'Soluciones de Correo Electrónico Profesional', subsCard3Desc: 'Protege tus comunicaciones con cifrado de extremo a extremo y protección avanzada.', subsCard3Btn: 'Explorar Nuestras Soluciones Seguras',
    ...
    rentingBenefitsTitle: 'Beneficios para su Empresa',
    rentingBen1T: 'Optimización de Costos', rentingBen1Desc: 'Reduzca el gasto de capital y convierta los costos fijos en gastos operativos flexibles.',
    rentingBen2T: 'Escalabilidad', rentingBen2Desc: 'Escale su infraestructura TI fácilmente según las necesidades de su negocio.',
    rentingBen3T: 'Mantenimiento sin Preocupaciones', rentingBen3Desc: 'El mantenimiento y actualizaciones del hardware son gestionados por nuestro equipo experto.',
    rentingBen4T: 'Última Tecnología', rentingBen4Desc: 'Acceso siempre a la tecnología más actual sin necesidad de grandes inversiones.',
    rentingBtn: 'Comenzar',

    /* PLANES SUBS PAGE (Pricing) */
    plansEyebrow: 'Planes de Suscripción', plansTitle: 'Planes de Suscripción',
    plan1Name: 'Suscripción Básica', plan2Name: 'Suscripción Profesional', plan3Name: 'Suscripción Empresarial',
    planPeriod: '/mes', planPopular: 'Más Popular', planBtn: 'Suscribirse Ahora',
    plan1F1: 'Hardware Estándar', plan1F2: 'Soporte Básico', plan1F3: 'Actualizaciones Mensuales',
    plan2F1: 'Hardware Premium', plan2F2: 'Soporte Prioritario', plan2F3: 'Actualizaciones Semanales', plan2F4: 'Garantía de Reemplazo',
    plan3F1: 'Hardware Personalizado', plan3F2: 'Soporte Dedicado 24/7', plan3F3: 'Actualizaciones Tiempo Real', plan3F4: 'Reemplazo Prioritario', plan3F5: 'Integración a Medida',

    /* CORREO PAGE */
    correoEyebrow: 'Correo Electrónico', correoTitle: 'Soluciones de Correo Electrónico Profesional',
    correoDesc: 'Servicios de correo electrónico seguros y confiables para su negocio',
    correoPerPeriod: '/mes por usuario', correoBtnStart: 'Comenzar',
    correo1Name: 'Email Pro', correo2Name: 'Email Business', correo3Name: 'Email Enterprise',
    correoWhyTitle: 'Por qué elegir nuestro servicio de correo electrónico',
    correoWhy1T: 'Imagen Profesional', correoWhy2T: 'Seguridad Mejorada', correoWhy3T: 'Amplio Almacenamiento',
    correoProF1: '10GB de Almacenamiento', correoProF2: 'Dominio personalizado', correoProF3: 'Interfaz web', correoProF4: 'Acceso móvil',
    correoBizF1: '50GB de Almacenamiento', correoBizF2: 'Dominio personalizado', correoBizF3: 'Filtrado avanzado de spam', correoBizF4: 'Calendarios compartidos', correoBizF5: 'Acceso móvil',
    correoEntF1: '100GB de Almacenamiento', correoEntF2: 'Dominio personalizado', correoEntF3: 'Seguridad avanzada', correoEntF4: 'Archivado de correo electrónico', correoEntF5: 'Soporte prioritario', correoEntF6: 'Herramientas de colaboración',
    ...
    prod3T: 'Soporte 24/7', prod3Desc: 'Mantenimiento continuo para asegurar el óptimo funcionamiento.',
    prod4T: 'Telecomunicaciones', prod4Desc: 'Infraestructura y servicios adaptados a cada organización.',
    prod5T: 'Cuentas de Correo Activanet', prod5Desc: 'Soluciones profesionales de correo electrónico.',
    prod6T: 'Líneas Móviles', prod6Desc: 'Planes corporativos y gestión de dispositivos.',
    prodAIBannerT: 'Descubre Nuestros Agentes Virtuales con IA',
    prodAIBannerD: 'Optimiza la atenci&oacute;n con asistentes 24/7.',

    /* PARTNERS PAGE */
    partnersEyebrow: 'Colaboraciones', partnersTitle: 'Nuestros Socios Estratégicos',
    partnersDesc: 'Colaboramos con empresas innovadoras para ofrecer soluciones de vanguardia',
    partners1T: 'Distribuidores Certificados', partners1D: 'Socios seleccionados para proporcionar soluciones personalizadas.',
    partners2T: 'Socios Tecnológicos', partners2D: 'Colaboraciones con líderes tecnológicos.',
    partners3T: 'Red Global', partners3D: 'Red internacional para soluciones localizadas.',
    ...
    contNamePlaceholder: 'Nombre', contEmailPlaceholder: 'Correo electrónico', contMsgPlaceholder: 'Mensaje',
    footerAddr: 'Calle las Palomas n 50 Urb EL Coto<br />Mijas Costa, Málaga, Spain',

    /* DIGITAL TRANSFORMATION */
    dtEyebrow: 'Innovaci&oacute;n', dtTitle: 'Digital <em>Transformation</em>',
    dtDesc: 'Acelere el crecimiento de su negocio con nuestras soluciones integrales.',
    dtWhyTitle: '&iquest;Por qu&eacute; elegir nuestros servicios?',
    dtWhyDesc: 'Ayudamos a navegar el viaje digital con soluciones que impulsan la eficiencia.',
    dtScheduleBtn: 'Programar una Consulta',
    ...
    hostItem1T: 'Hosting Compartido Premium', hostItem1Desc: 'Recursos garantizados y herramientas avanzadas.',
    hostItem2T: 'M&aacute;ximo Rendimiento', hostItem2Desc: 'SSD NVMe, cach&eacute; optimizado y CloudLinux.',
    hostItem3T: 'Seguridad Avanzada', hostItem3Desc: 'SSL gratuito, antimalware y backups diarios.',
    hostPlanesBtn: 'Ver Planes de Hosting',

    /* PLANES HOSTING PAGE */
    hostPlanesEyebrow: 'Planes de Hosting', hostPlanesTitle: 'Elige el plan<br/><em>que mejor se adapta</em>',
    hostPlanesDesc: 'Migración gratuita, soporte técnico y SSL desde el primer día.',
    planHostBasico: 'Plan B&aacute;sico', planHostPro: 'Plan Profesional', planHostEmp: 'Plan Empresa',
    ...
    cloudDedTitle: 'Cloud Dedicado y Distribuido', cloudDedDesc: 'Infraestructura con máximo rendimiento y control.',
    cloudDedSolTitle: 'Nuestras Soluciones Cloud', cloudDedSolDesc: 'Listos para llevar tu TI al siguiente nivel.',
  ...
  en: {
    navInicio: 'Home', navSuscripciones: 'Subscriptions', navHosting: 'Web Hosting',
    ...
    serv3T: 'Digital Security', serv3Desc: 'Protection against threats with integrated cybersecurity.',
    serv4T: 'Cloud Computing', serv4Desc: 'Flexible and scalable infrastructure.',
    serv5T: 'Telecommunications', serv5Desc: 'Modern communication: voice, data and mobile.',
    serv6T: '24/7 Technical Support', serv6Desc: 'Expert assistance ensuring continuity.',
    subsEyebrow: 'Subscriptions', subsTitle: 'Subscriptions', subsDesc: 'Discover our solutions and subscriptions',
    subsCard1T: 'Hosting Plans', subsCard1Desc: 'Professional web hosting for your site', subsCard1Btn: 'View Hosting Plans',
    ...
    rentingBenefitsTitle: 'Business Benefits',
    rentingBen1T: 'Cost Optimization', rentingBen1Desc: 'Reduce capital expenditure.',
    rentingBen2T: 'Scalability', rentingBen2Desc: 'Scale your IT infrastructure easily.',
    rentingBen3T: 'Worry-Free Maintenance', rentingBen3Desc: 'Managed by our expert team.',
    rentingBen4T: 'Latest Technology', rentingBen4Desc: 'Access latest tech without major investment.',
    rentingBtn: 'Get Started',
    plansEyebrow: 'Subscription Plans', plansTitle: 'Subscription Plans',
    plan1Name: 'Basic', plan2Name: 'Professional', plan3Name: 'Enterprise',
    planPeriod: '/mo', planPopular: 'Most Popular', planBtn: 'Subscribe Now',
    plan1F1: 'Standard Hardware', plan1F2: 'Basic Support', plan1F3: 'Monthly Updates',
    plan2F1: 'Premium Hardware', plan2F2: 'Priority Support', plan2F3: 'Weekly Updates', plan2F4: 'Replacement Guarantee',
    plan3F1: 'Custom Hardware', plan3F2: '24/7 Dedicated Support', plan3F3: 'Real-Time Updates', plan3F4: 'Priority Replacement', plan3F5: 'Bespoke Integration',
    correoEyebrow: 'Email', correoTitle: 'Professional Email Solutions',
    correoDesc: 'Secure and reliable services.',
    correoPerPeriod: '/mo per user', correoBtnStart: 'Get Started',
    correo1Name: 'Email Pro', correo2Name: 'Email Business', correo3Name: 'Email Enterprise',
    correoWhyTitle: 'Why choose our email',
    correoWhy1T: 'Professional Image', correoWhy2T: 'Security', correoWhy3T: 'Storage',
    correoProF1: '10GB Storage', correoProF2: 'Custom domain', correoProF3: 'Web interface', correoProF4: 'Mobile access',
    correoBizF1: '50GB Storage', correoBizF2: 'Custom domain', correoBizF3: 'Spam filtering', correoBizF4: 'Calendars', correoBizF5: 'Mobile access',
    ...
    prod3T: '24/7 Support', prod3Desc: 'Continuous maintenance.',
    prod4T: 'Telecom', prod4Desc: 'Enterprise services.',
    prod5T: 'Activanet Email', prod5Desc: 'Professional solutions.',
    prod6T: 'Mobile Lines', prod6Desc: 'Corporate plans.',
    prodAIBannerT: 'Virtual AI Agents',
    prodAIBannerD: '24/7 assistant optimization.',
    partnersEyebrow: 'Partners', partnersTitle: 'Strategic Partners',
    partnersDesc: 'Collaborating for vanguard solutions',
    partners1T: 'Distributors', partners1D: 'Custom solutions.',
    ...
    contNamePlaceholder: 'Name', contEmailPlaceholder: 'Email', contMsgPlaceholder: 'Message',
    footerAddr: 'Calle las Palomas n 50 Urb EL Coto<br />Mijas Costa, Malaga, Spain',
    dtEyebrow: 'Innovation', dtTitle: 'Digital <em>Transformation</em>',
    dtDesc: 'Accelerate business growth.',
    dtWhyTitle: 'Why Choose Us?',
    ...
    hostItem1T: 'Premium Shared', hostItem1Desc: 'Advanced tools.',
    hostItem2T: 'Max Performance', hostItem2Desc: 'NVMe SSD and CloudLinux.',
    hostItem3T: 'Security', hostItem3Desc: 'SSL and backups.',
    hostPlanesBtn: 'View Plans',
    hostPlanesEyebrow: 'Hosting Plans', hostPlanesTitle: 'Choose Plan',
  ...
  fr: {
    navInicio: 'Accueil', navSuscripciones: 'Abonnements', navHosting: 'Hébergement Web',
    ...
    serv3T: 'Sécurité Numérique', serv3Desc: 'Cybersécurité intégrée.',
    serv4T: 'Cloud Computing', serv4Desc: 'Infrastructure flexible.',
    serv5T: 'Télécommunications', serv5Desc: 'Communications modernes.',
    serv6T: 'Support 24/7', serv6Desc: 'Assistance experte.',
    subsEyebrow: 'Abonnements', subsTitle: 'Abonnements', subsDesc: 'Découvrez nos solutions',
    subsCard1T: 'Plans d\'Hébergement', subsCard1Desc: 'Hébergement pro', subsCard1Btn: 'Voir Plans',
    ...
    rentingBenefitsTitle: 'Avantages',
    rentingBen1T: 'Optimisation Coûts', rentingBen1Desc: 'Réduction des dépenses.',
    rentingBen2T: 'Évolutivité', rentingBen2Desc: 'Évoluez facilement.',
    rentingBen3T: 'Maintenance', rentingBen3Desc: 'Géré par nos experts.',
    rentingBen4T: 'Dernière Tech', rentingBen4Desc: 'Accès au meilleur hardware.',
    rentingBtn: 'Commencer',
    plansEyebrow: 'Abonnements', plansTitle: 'Plans d\'Abonnement',
    plan1Name: 'Basique', plan2Name: 'Professionnel', plan3Name: 'Entreprise',
    planPeriod: '/mois', planPopular: 'Populaire', planBtn: 'S\'abonner',
    plan1F1: 'Hardware Standard', plan1F2: 'Support Basique', plan1F3: 'Updates Mensuels',
    plan2F1: 'Hardware Premium', plan2F2: 'Support Prioritaire', plan2F3: 'Updates Hebdo', plan2F4: 'Garantie Remplacement',
    plan3F1: 'Hardware Sur-mesure', plan3F2: 'Support 24/7', plan3F3: 'Temps réel', plan3F4: 'Priorité', plan3F5: 'Intégration',
    correoEyebrow: 'Email', correoTitle: 'Solutions Email Pro',
    correoDesc: 'Services sécurisés.',
    correoPerPeriod: '/mois par user', correoBtnStart: 'Démarrer',
    correo1Name: 'Email Pro', correo2Name: 'Email Business', correo3Name: 'Email Enterprise',
    correoWhyTitle: 'Pourquoi nous choisir ?',
    correoWhy1T: 'Image Pro', correoWhy2T: 'Sécurité', correoWhy3T: 'Stockage',
    correoProF1: '10Go Stockage', correoProF2: 'Domaine pro', correoProF3: 'Web', correoProF4: 'Mobile',
    correoBizF1: '50Go Stockage', correoBizF2: 'Domaine pro', correoBizF3: 'Anti-spam', correoBizF4: 'Calendriers', correoBizF5: 'Mobile',
    ...
    prod3T: 'Support 24/7', prod3Desc: 'Maintenance continue.',
    prod4T: 'Telecom', prod4Desc: 'Services entreprise.',
    prod5T: 'Activanet Email', prod5Desc: 'Email entreprise.',
    prod6T: 'Mobiles', prod6Desc: 'Forfaits mobiles.',
    prodAIBannerT: 'Agents IA',
    prodAIBannerD: 'Service client 24/7.',
    partnersEyebrow: 'Partenaires', partnersTitle: 'Partenaires Stratégiques',
    partnersDesc: 'Innovation partagée',
    partners1T: 'Distributeurs', partners1D: 'Solutions sur mesure.',
    ...
    footerAddr: 'Calle las Palomas n 50 Urb EL Coto<br />Mijas Costa, Malaga, Espagne',
    dtEyebrow: 'Innovation', dtTitle: 'Transformation <em>Digitale</em>',
    dtDesc: 'Croissance digitale accélérée.',
    dtWhyTitle: 'Pourquoi nous ?',
    ...
    hostItem1T: 'Hosting Premium', hostItem1Desc: 'Outils pro.',
    hostItem2T: 'Performance Max', hostItem2Desc: 'SSD NVMe.',
    hostItem3T: 'Sécurité', hostItem3Desc: 'SSL et backups.',
    hostPlanesBtn: 'Voir Plans',
    hostPlanesEyebrow: 'Plans Hosting', hostPlanesTitle: 'Choisir Plan',
    ...
    consultBtn: 'Demander Consultation',
  ...
  document.querySelectorAll('[data-i18n]').forEach(function(el) {
    ...
    if (t[key] !== undefined) {
      if (el.tagName === 'INPUT' || el.tagName === 'TEXTAREA') {
        el.placeholder = t[key].replace(/<br\s*\/?>/gi, ' ');
      } else {
        if (t[key].indexOf('<') !== -1 || t[key].indexOf('&') !== -1) {
          el.innerHTML = t[key];
        } else {
...
function setActiveNav(page) {
  document.querySelectorAll('.nav-link').forEach(function(l) { 
    ...
    if (page === 'daas' && dp === 'suscripciones') l.classList.add('current');
    if ((page === 'cloud-privada' || page === 'cloud-dedicado') && dp === 'cloud') l.classList.add('current');
    if ((page === 'infraestructura' || page === 'seguridad' || page === 'soporte' || page === 'telecomunicaciones' || page === 'moviles') && dp === 'productos') l.classList.add('current');
  });
}
